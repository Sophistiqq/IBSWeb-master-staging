        ...
        #region -- Generate Collection Excel File --
            ...
            public async Task<IActionResult> GeneratePostedCollectionExcelFile(ViewModelBook model, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    worksheet.Cells["I7"].Value = "CHECK DATE";
                        ...
                        bool formatDueDate)
                    {
                        ...
                        worksheet.Cells[row, 8].Value = dueDate;
                        worksheet.Cells[row, 9].Value = collectionReceipt.CheckDate;
                    ...
                    using (var range = worksheet.Cells[8, 4, lastRow, 8])
                    {
