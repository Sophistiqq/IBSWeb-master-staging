...
namespace IBS.Services
{
    public class LocalFileStorageService : ICloudStorageService
    {
        ...
        public LocalFileStorageService(IOptions<GCSConfigOptions> options, ILogger<LocalFileStorageService> logger, IWebHostEnvironment environment, IConfiguration configuration)
        {
            _options = options.Value;
            _logger = logger;

            // Use LocalStoragePath from config if available, otherwise default to App_Data/LocalStorage
